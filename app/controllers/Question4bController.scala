...
import pages.{Question4bPage, QuestionPage}
...
class Question4bController @Inject()(
  ...
  override val page: UrlParams => QuestionPage[Int] = _ => Question4bPage

  override val viewModel: Populate[IntPageViewModel] =
    Populate.const(IntPageViewModel(
      DisplayMessage("question4b.title"),
      DisplayMessage("question4b.heading"),
      _.fromMode(routes.Question4bController.onSubmit)
    ))
