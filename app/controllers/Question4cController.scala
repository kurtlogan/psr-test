...
import pages.{Question4cPage, QuestionPage}
...
class Question4cController @Inject()(
  ...
  override val page: UrlParams => QuestionPage[Int] = _ => Question4cPage

  override val viewModel: Populate[IntPageViewModel] =
    Populate.const(IntPageViewModel(
      DisplayMessage("question4c.title"),
      DisplayMessage("question4c.heading"),
      _.fromMode(routes.Question4cController.onSubmit)
    ))
